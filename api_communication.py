...
headers = {
    'authorization': API_KEY_ASSEMBLYAI}  # set this to our API key #we are actually doing a post request with header
...
def get_transcription_result_url(audio_url):
    ...
    while True:
        ...
        def save_transcript(audio_url, filename):
            ...
            if data:
                text_filename = filename + ".doc"  # you can use any format of file you want
